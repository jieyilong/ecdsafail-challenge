...
`cls / pha / anc` on nonce `1095799875`. The local env-less benchmark was then
...
avg executed Toffoli    : 1431196.182
qubits                  : 1216
score                   : 1740334336
```
...
`2f932e8` at `1713097160`, so the submission is expected to be rejected. It is
